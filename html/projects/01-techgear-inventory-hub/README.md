...
**Challenge Level:** Hard—calculate tfoot totals manually from data (e.g., sum prices/stocks), nest form outputs in preview dl (e.g., "New Stock: <output>150</output>"), validate screenshot fidelity. Time: 4-6 hours. Test: Browser + NVDA for form/table flow. Output: index.html, commit "Day-1-2-Inventory-Build".

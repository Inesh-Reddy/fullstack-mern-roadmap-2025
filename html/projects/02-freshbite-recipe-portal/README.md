...
- **Headings & Text Content:** Original h1 ("Contact") to h2. New `<h1>`: "FreshBite Recipes". `<h3-h6>` for 6 recipes (e.g., `<h4>Ingredient List</h4><h6>From Grocery Notes</h6>`), ps with strong/em (e.g., "<strong>Fresh ingredients only!</strong> <em>Per your notes.</em>").
